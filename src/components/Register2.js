...
class Register extends Component {
    ...
    handleInputChange(e) {
        ...
        console.log(this.state.constitutionMale);
    }
    ...
    getPickerValue = (value) => {
        this.state.dob1= value;
        
      }
    checkProfileType(e) {
        
        if (this.state.selectValue === 'male') {
        ...
        else if (this.state.selectValue === 'female') {
    ...
    finishRegister(e) {
        ...
        if ((this.state.selectValue === 'male') && (this.state = { show1: false })) {
        ...
        else if ((this.state.selectValue === 'female') && (this.state = { show1: false })) {
